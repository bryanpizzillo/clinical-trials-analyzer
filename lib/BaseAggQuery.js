...
class BaseAggQuery {
    ...
    /**
     * When querying/filtering you can use this function for an additional "should" clause
     * to filter any trials by a "View-able" trial status.  
     * 
     * @returns
     * 
     * @memberOf BaseAggQuery
     */
    _getViewAbleTrialsFilterArray() {
        return [
